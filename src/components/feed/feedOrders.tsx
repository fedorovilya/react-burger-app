					...
					<div className={style.imageStack}>
						...
						{hasOverflow && (
							<div
								...
								<img
									className={`${style.imageWrapper_img} ${style.imageWrapper_img_overflow}`}
									src={orderIngredients[MAX_VISIBLE]?.image}
									alt='overflow'
								/>
	...
	return (
		<>
			...
			<div className={style.flex}>
				{!isPrivate && (
					<p className={'pt-10 pb-10 text text_type_main-large'}>
						Лента заказов
					</p>
				)}
